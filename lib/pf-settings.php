			...
			<?php
				...
				$settings = array(
					...
					'prdctfltr_loader' => array(
						'name' => esc_html__( 'Select AJAX Loader Icon', 'prdctfltr' ),
						'type' => 'select',
						'desc' => esc_html__( 'Select AJAX loader icon.', 'prdctfltr' ),
...
/*
							'audio' => esc_html__( 'Audio', 'prdctfltr' ) . ' DEPRECATED',
							'ball-triangle' => esc_html__( 'Ball Triangle', 'prdctfltr' ) . ' DEPRECATED',
							'bars' => esc_html__( 'Bars', 'prdctfltr' ) . ' DEPRECATED',
							'circles' => esc_html__( 'Circles', 'prdctfltr' ) . ' DEPRECATED',
							'grid' => esc_html__( 'Grid', 'prdctfltr' ) . ' DEPRECATED',
							'hearts' => esc_html__( 'Hearts', 'prdctfltr' ) . ' DEPRECATED',
							'oval' => esc_html__( 'Oval', 'prdctfltr' ) . ' DEPRECATED',
							'puff' => esc_html__( 'Puff', 'prdctfltr' ) . ' DEPRECATED',
							'rings' => esc_html__( 'Rings', 'prdctfltr' ) . ' DEPRECATED',
							'spinning-circles' => esc_html__( 'Spining Circles', 'prdctfltr' ) . ' DEPRECATED',
							'tail-spin' => esc_html__( 'Tail Spin', 'prdctfltr' ) . ' DEPRECATED',
							'circles' => esc_html__( 'Circles', 'prdctfltr' ) . ' DEPRECATED',
							'three-dots' => esc_html__( 'Three Dots', 'prdctfltr' ) . ' DEPRECATED'*/
						),
				...
				?>
						...
						<?php
							...
							?>
							<span class="prdctfltr_override"><input type="checkbox" class="pf_override_checkbox" /> <?php echo esc_html__( 'Term slug', 'prdctfltr' ) . ' : <span class="slug">' . $k . '</span>'; ?> <?php echo esc_html__( 'Filter Preset', 'prdctfltr' ) . ' : <span class="preset">' . $v; ?></span> <a href="#" class="button prdctfltr_or_remove"><?php esc_html_e( 'Remove Override', 'prdctfltr' ); ?></a><span class="clearfix"></span></span>
							<?php
								}
							}
						?>
				...
				<div class="prdctfltr_quickview_terms" data-key="<?php echo $key; ?>"<?php echo $addkey !== '' ? ' data-addkey="' . $addkey . '"' : ''; ?>>
					...
					<div class="prdctfltr_quickview_terms_inner">
						<div class="prdctfltr_quickview_terms_settings">
							<span class="prdctfltr_set_terms" data-taxonomy="<?php echo $curr_filter; ?>"><?php esc_html_e( 'Taxonomy', 'prdctfltr' ); ?>: <code><?php echo $curr_filter; ?></code></span>
...
?>
					<div class="prdctfltr_quickview_filter">
						...
						<a href="#" class="button prdctfltr_filter_remove"><?php esc_html_e( 'Remove', 'prdctfltr' ); ?></a>
					</div>
<?php
					$html = ob_get_clean();
					die( $html );
			...
			<div class="prdctfltr_quickview_terms" data-key="<?php echo $key; ?>">
				...
				<div class="prdctfltr_quickview_terms_inner">
					<div class="prdctfltr_quickview_filters_settings">
						<span class="prdctfltr_set_filters_type" data-filter="<?php echo $filter; ?>"><?php esc_html_e( 'Type', 'prdctfltr' ); ?>: <code><?php echo $filter; ?></code></span>
